...
public class SecretQuestionSecretData {
    ...
    public static final Logger logger = Logger.getLogger(SecretQuestionSecretData.class);
     ...
     */
    @JsonCreator
    public SecretQuestionSecretData(@JsonProperty("value") String value, @JsonProperty("salt") String salt, @JsonProperty("algorithmData") Map<String, List<String>> additionalParameters) throws IOException {
     ...
     * @param salt salt
     */
    public SecretQuestionSecretData(String value, byte[] salt) {
        this.value = value;
        this.salt = salt;
