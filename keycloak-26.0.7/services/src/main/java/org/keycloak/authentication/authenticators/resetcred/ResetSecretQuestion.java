 ...
 * @version $Revision: 1 $
 */
public class ResetSecretQuestion extends AbstractSetRequiredActionAuthenticator {

    public static final String PROVIDER_ID = "reset-secret-question";
    ...
    public String getDisplayType() {
        return "Reset Secret Question";
    }

    @Override
    public String getHelpText() {
        return "Sets the Update Secret Question required action if execution is REQUIRED.  Will also set it if execution is OPTIONAL and the password is currently configured for it.";
    }
